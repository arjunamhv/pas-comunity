    ...
    <div class="max-w-md w-full bg-white shadow-xl rounded-lg overflow-hidden">
        ...
        <div class="p-6">
            <div class="flex justify-center mb-6 mt-4">
                <img src="{{ $user->foto ? env('MINIO_ENDPOINT') . '/pas-comunity/' . $user->foto : asset('img/id_card_foto.png') }}"
                    alt="User Photo" class="w-32 h-32 rounded-full shadow-lg border-4 border-red-500 object-cover">
            </div>
            ...
            <div class="flex justify-center">
                ...
                <button type="button" onclick="getTypes()"
            ...
            fetch('{{ route('relations.create') }}', {
                ...
                .then(data => {
                    if (data.message && data.message === 'Unauthenticated.') {
                        ...
                        Swal.fire('Error', 'Failed to fetch relationship types.', 'error');
                    }
                })
                .catch(error => {
