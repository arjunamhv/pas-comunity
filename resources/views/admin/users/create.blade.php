<x-admin-layout>
    ...
    <div class="p-6">
        <h2 class="text-2xl font-semibold text-gray-700">Create User</h2>

        <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data" class="mt-6">
            @csrf
            ...
            <div class="flex items-center gap-6 mb-4">
                ...
                <div class="flex-shrink-0">
                    <img id="preview-image" src="{{ asset('img/id_card_foto.png') }}"
            ...
            <div class="mb-4">
                ...
                <textarea id="detail_alamat" name="detail_alamat" class="mt-1 block w-full" required>{{ old('detail_alamat') }}</textarea>
